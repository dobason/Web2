...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (copy($_FILES["bookImage"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO sach (Ten_Sach, The_Loai, Ten_Tac_Gia, Mo_Ta, Don_Gia, Hinh_Anh, Trang_Thai, Ten_NXB)
                    VALUES ('$bookTitle', '$bookCategory', '$bookAuthor', '$bookDescription', '$bookPrice', '$targetFile', '1', '$bookPublisher')";
            execute($sql);
