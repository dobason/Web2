...
if ($sach) {
    foreach ($sach as $book) {
        ...
        $imagePath = $book['Hinh_Anh']; // Đây là tên hình ảnh như lưu trong cột Hinh_Anh

        // Kiểm tra xem đường dẫn hình ảnh có chứa 'http' hay không
     
            $finalImagePath = $imagePath;

        echo '<div class="slider-product-one-content-item">';
        echo '<a href="product.html"><img src="' . $finalImagePath . '" alt="Book Image" width="500"></a>';
