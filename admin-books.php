    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="editBookModalBody">
                <!-- Nội dung modal sửa sẽ được tải bằng AJAX -->
            </div>
        </div>
    </div>
</div>
<script>
   $(document).ready(function() {
    ...
    $('.edit-book').click(function() {
        ...
        // Sử dụng AJAX để tải nội dung của modal sửa thông tin sách từ process_edit_book.php
        $.ajax({
            type: 'POST',
            url: 'process_edit_book.php',
            data: { bookId: bookId },
            success: function(response) {
                $('#editBookModalBody').html(response);
            },
            error: function(error) {
                console.log('Lỗi khi tải nội dung sửa sách:', error);
            }
        });
    });
});
