...
<head>
  ...
  <style>
    ...
    margin: 0;
    padding: 0;
    height: 100vh; /* Thiết lập chiều cao của body là 100% chiều cao của viewport */
    background: linear-gradient(to right, #805a3b, #aa9775);
    display: flex;
...
<body>
  ...
  function isUsernameExists($username) {
    $sql = "SELECT COUNT(*) as total FROM khach_hang WHERE Tai_Khoan = '$username'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isUsernameExists($username)) {
        ...
        if ($password !== $confirmPassword) {
            ...
            $sql = "INSERT INTO khach_hang (Ten_KH, Tai_Khoan, Mat_Khau, SDT, Trang_Thai, Thanh_Pho, Quan, Phuong) VALUES ('$fullname', '$username', '$hashedPassword', '$phone', 1, '$thanhPho', '$quan', '$phuong')";
            execute($sql);
